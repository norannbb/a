...
def telethon_session():
    ...
    # logging in
    try:
        with TelegramClient(StringSession(), API_ID, API_HASH) as aud9i:
            print("Generating a string session for •aud9i•")
            try:
                aud9i.send_message(
                    "me",
...
def pyro_session():
    ...
    with Client(
        name="aud9i", api_id=API_ID, api_hash=API_HASH, in_memory=True
    ) as pyro:
