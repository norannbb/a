    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس اودي الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐞𝐩𝐭𝐡𝐨𝐧", "https://t.me/aud9i"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "aud9i")
            ...
            await bot.send_file("@BotFather", "zthon/audi/logoad.jpg")
            ...
            await bot.send_message("@BotFather", f"- بـوت اودي المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
zthon = {"@aud9i", "@adthon1", "@adthon1", "@P17_12", "@aud9i_Help"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="audi/malath/aud9i.jpg")
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="audi/malath/aud.jpg")
