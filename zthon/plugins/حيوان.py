...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 𓆪 </b> - @aud9i "
...
async def who(event):
    ...
    if replied_user.id == 1260465030 or replied_user.id == 1895219306 or replied_user.id == 2095357462:
