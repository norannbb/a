...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - حفـظ الذاتـيـة ♥️](t.me/aud9i) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
...
async def start_datea(event):
    global zedself
    if zedself:
        return await edit_or_reply(event, "**𓆰حفظ الذاتيـة التلقـائي .. مفعـله مسـبـقًا ☑️  الله لا يسامحك اذا تستخدمه بشي  خطأ او ابتزاز**")
    zedself = True
    await edit_or_reply(event, "**𓆰تم تفعيـل حفظ الذاتيـة التلقائـي .. بنجـاح ☑️ الله لا يسامحك اذا تستخدمها بشي لا يرضي الله**")
