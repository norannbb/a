...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت اودي"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 ─┄─┄─┄─⋆"
zed_dev = (1260465030, 463636842)
