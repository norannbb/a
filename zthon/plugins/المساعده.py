...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            buttons = [
                [Button.inline("S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊", data="ZAZ")],
                [
        ...
        await event.edit(
            ...
            buttons=[
                ...
                [
                    ...
                    Button.inline("اودي اودي", data="zedvr"),
                ],
                [
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس اودي
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر المجمــوعــه 🛗](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/aud9i) .
**- الامـر :**
**⪼** `.حذف رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر مكـافح التكــرار 🛡](t.me/aud9i) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر المنــع 🚫](t.me/aud9i) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الاضـافه والتفليـش 👾](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الفــارات 🧬](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر فــارات الوقتــي 🕰](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر فــارات الفحـص 🏮](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس اودي بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر التسليـه 🏂](t.me/aud9i) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر التحشيش 🎃](t.me/aud9i) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الالـعــاب 🎮🎳](t.me/aud9i) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر حمـايــة الخــاص 🛡](t.me/aud9i) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - فــارات حمـايــة الخــاص 🛡](t.me/aud9i) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر المـرفقــات 🖥](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الستـوريـات 🎆🏖](t.me/aud9i) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/aud9i) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/aud9i) .
**- الامـر :**
...
**- ملاحظـه :**
سـورس اودي هو اول من كتب فكرة الاشتراك الاجباري واضافها للسورس كـ فكرة جديدة لسورسات تيليثون
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر الصيـد & التشيكـر ❇️](t.me/aud9i) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر تجميـع النقـاط 💡](t.me/aud9i) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر تجميــع النقــاط 🛂](t.me/aud9i) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 - اوامــر النشــر التلقــائي 🌐](t.me/aud9i) .
**- الامـر :**
**⪼** `.تلقائي`
