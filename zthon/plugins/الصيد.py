...
ZelzalChecler_cmd = (
    ...
    "𓆩 [ ���� - أوامـر الصيد والتشيكـر](t.me/aud9i) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن اودي**\n\n"
...
"𓆩 [ ���� - أنـواع اليـوزرات](t.me/aud9i) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    about="This channel to hunt username by - @aud9i ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                about="تم تثبيت اليـوزر بواسطـة سـورس اودي - @aud9i ",
