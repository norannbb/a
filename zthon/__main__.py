...
LOGS = logging.getLogger("سورس اودي")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["aud9i","P17_12","adthon1","adthon1","aud9i_Help","super_aud9i","adthon2","x_wwl","K_K_Q_L","Visaaud9i","zszxzz","TIKTOK_ased","huueuu","PyThOnX1"]
