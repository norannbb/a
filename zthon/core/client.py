                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @billdu\
                                  \n\n--------بـدء تتبـع سجـل اودي S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع اودي S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊--------"
                        ...
                        link = "[بيدو(https://t.me/billdu)"
                        text = (
                            "**✘ تقـريـر إشعـار اودي S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار اودي S𝑂𝑈𐍂𝒄𝐸 𝐴𝑈𝒅𝒊 ✘**\n\n "
                        link = "[بيدو(https://t.me/billdu)"
